...
def run_sunshadow(scanned_elev, env, **kwargs):
    gs.run_command("r.sunmask", elevation=scanned_elev, year=2022, month=2, day=22, hour=10, minute=30, timezone=-5, output="shadow", env=env)
